        ...
        <div className="container mx-auto px-4 md:px-6 h-14 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="font-bold tracking-tighter text-lg md:text-xl text-foreground group-hover:text-primary transition-colors">
              WALL ST. <span className="text-muted-foreground font-mono text-xs tracking-normal ml-1">LAUNCHPAD</span>
            </span>
          </Link>
      ...
      <footer className="border-t border-border py-8 mt-24">
        <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            <a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-xs">Twitter</a>
            <a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-xs">Discord</a>
            <a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-xs">Docs</a>
          </div>
        </div>
      </footer>
    </div>
